...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.fetchUserInfo();  //user info like name, email, phone number
  }
  ...
  //if address given edit it or add 
  ...
  get paginatedOrders(): any[] {
    if (!this.userInfo?.orderItemList) return []; //if no orders return empty 
